...
def compare_against_encoding_list(face_encoding, known_face_encodings_list, tolerated_difference=.63):
    '''
    tolerated_distance: indicates how far or not similar are 2 images, where 0 distance is exactly equal and 1 totally different 
    '''
